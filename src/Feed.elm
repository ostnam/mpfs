...
type Msg = AddFeed String String
         | DeleteFeed
...
view msg = Document "MPFS" [Html.Styled.toUnstyled (view_body msg)]
...
render_left_bar l = div [id "leftbar"] [
  render_options
  ]
...
render_options =
  div [ css [
    ...
    div [css option_button_style] [img [src "static/images/refresh.png", css option_img_style] []],
